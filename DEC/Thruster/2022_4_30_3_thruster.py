    ...
    try:
        ...
        if speed == 1500:
            try:
                ...
                if ERR_gps == 1 and list_err_0 == list_err_1 == list_err_2 == list_err_3 == list_err_4 == list_err_5 == list_err_6 == list_err_7 == list_err_8 == list_err_9 == list_err_10 == list_err_11 == list_err_12 == list_err_13 == list_err_14 == list_err_15 == list_err_16 == list_err_17 == list_err_18 == list_err_19:
                    print("GPS_ERR, SERVER_ERR")
                    pi2.set_servo_pulsewidth(19, 1500)
                    pi2.set_servo_pulsewidth(9, 1500)

                elif list_err_0 == list_err_1 == list_err_2 == list_err_3 == list_err_4 == list_err_5 == list_err_6 == list_err_7 == list_err_8 == list_err_9 == list_err_10 == list_err_11 == list_err_12 == list_err_13 == list_err_14 == list_err_15 == list_err_16 == list_err_17 == list_err_18 == list_err_19:
                    print("SERVER_ERR")
                    pi2.set_servo_pulsewidth(19, 1500)
                    pi2.set_servo_pulsewidth(9, 1500)
                ...
                print(
                    "left: " + GPS_left_str + " right: " + GPS_right_str + " distance: " + GPS_distance_str + " err_gps: " + ERR_gps_str + " err_server: " + ERR_server_str )
                with open('/home/pi/EsbServer/DataFiles/Thruster/Thruster_backup.dat', 'w') as FileOpen:
                    FileOpen.write(GPS_left_str + " " + GPS_right_str + " " + GPS_distance_str + " " + ERR_gps_str + " " + ERR_server_str)
            except IndexError:
